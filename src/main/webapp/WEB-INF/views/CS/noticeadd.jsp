...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/customer_css/editor.css" type="text/css" charset="utf-8"/>
    <script src="${pageContext.request.contextPath}/resources/js/editor_loader.js?environment=development" type="text/javascript" charset="utf-8"></script>
...
<body>
                <div class="col-sm-9">
                    <div id="gocont">
        <form id="tx_editor_form" name="tx_editor_form" action="${pageContext.request.contextPath}/noticeadd/add" method="post"  accept-charset="utf-8">
          <input type="hidden" name="${_csrf.parameterName}"
         value="${_csrf.token}" />
           <%-- <img id="tx_resize_holder" src="${pageContext.request.contextPath}/resources/images/icon/editor/skin/01/btn_drag01.gif" width="58" height="12" unselectable="on" alt="" /> --%>
            <fieldset>
                      ...
                      <table> 
                        ...
                        <tbody id="itemBody">
                            ...
                            <tr class="itemArea HTML">
                                ...
                                <td>
                                    <div class="pr">
                                       <!--<textarea name="notice_content" class="contents inp" cols="30" rows="4" maxlength="5000" required="required"></textarea>-->
						...
						<div id="tx_richtextbox_menu" class="tx-richtextbox-menu tx-menu">
							...
							<div class="tx-menu-footer">
								<img class="tx-menu-confirm"
									 src="${pageContext.request.contextPath}/resources/images/icon/editor/btn_confirm.gif?rv=1.0.1" alt=""/>
								<img class="tx-menu-cancel" hspace="3"
									 src="${pageContext.request.contextPath}/resources/images/icon/editor/btn_cancel.gif?rv=1.0.1" alt=""/>
							</div>
						</div>
					</li>
					<li class="tx-list">
	...
	<div id="tx_canvas" class="tx-canvas">
		<div id="tx_loading" class="tx-loading"><div><img src="${pageContext.request.contextPath}/resources/images/icon/editor/loading2.png" width="113" height="21" align="absmiddle"/></div></div>
	...
	<div id="tx_attach_div" class="tx-attach-div">
		...
		<div id="tx_attach_box" class="tx-attach-box">
			<div class="tx-attach-box-inner">
				<div id="tx_attach_preview" class="tx-attach-preview"><p></p><img src="${pageContext.request.contextPath}/resources/images/icon/editor/pn_preview.gif" width="147" height="108" unselectable="on"/></div>
	...
	var config = {
		...
		txIconPath: "${pageContext.request.contextPath}/resources/images/icon/editor/", /*에디터에 사용되는 이미지 디렉터리, 필요에 따라 수정한다. */
		txDecoPath: "${pageContext.request.contextPath}/resources/images/deco/contents/", /*본문에 사용되는 이미지 디렉터리, 서비스에서 사용할 때는 완성된 컨텐츠로 배포되기 위해 절대경로로 수정한다. */
		canvas: {
			styles: {
				color: "#123456", /* 기본 글자색 */
...
<script type="text/javascript">
	...
	function setForm(editor) {
        ...
        <div class="bn_wrap v2">
            <span><button  onclick='saveContent()' id="btnSend">등록</button></span>
