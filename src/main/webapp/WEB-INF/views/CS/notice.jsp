                 ...
                 <div id="noticeAll">
                  <table class="table table-hover mt-3">
                     ...
                     <tbody>
                        ...
                        <a type="button" class="btn delnotice btn-sm" onclick="del(${list.notice_no})" style='border:1px solid #274555'>삭제</a></div>
                        </sec:authorize>
                        ${list.notice_content}
                 ...
                 <div id="noticecom">
                  <table class="table table-hover mt-3">
                     ...
                     <tbody>
                        ...
                        <div class="delsection">
                        <sec:authorize access="hasRole('ROLE_ADMIN')">
                        <a type="button" class="btn delnotice btn-sm" onclick='del(${list.notice_no})' style="border:1px solid #274555">삭제</a>
                        </sec:authorize>
                        </div>
