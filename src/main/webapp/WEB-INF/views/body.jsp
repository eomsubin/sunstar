					...
					<div class="product-info">
						<div class="nav-main">
							...
							<ul class="nav nav-tabs" id="myTab" role="tablist">
								<li class="nav-item"><a class="nav-link active"
									data-toggle="tab" href="#fashion" role="tab">${category[0].lv1}</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab"
									href="#digital" role="tab">${category[1].lv1}</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab"
									href="#furniture" role="tab">${category[2].lv1}</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab"
									href="#food" role="tab">${category[3].lv1}</a></li>
								<li class="nav-item"><a class="nav-link" data-toggle="tab"
									href="#animal" role="tab">${category[4].lv1}</a></li>
						...
						<div class="tab-content" id="myTabContent">
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												...
												<div class="single-product">
													<div class="product-img">
														<a
															href="${pageContext.request.contextPath}/detailview2?product_code=${fashion.product_code}">
															<img class="default-img"
															src="${pageContext.request.contextPath}/${fashion.thumb_img}"
							...
							<div class="tab-pane fade" id="digital"
								...
								<div class="tab-single">
									<div class="row">
										<c:forEach var="digital" items="${digital }">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">

												<div class="single-product">
													<div class="product-img">
														<a
															href="${pageContext.request.contextPath}/detailview2?product_code=${digital.product_code}">
															<img class="default-img"
															src="${pageContext.request.contextPath}/${digital.thumb_img}"
															alt="#"> <img class="hover-img"
															src="${pageContext.request.contextPath}/${digital.thumb_img}"
															alt="#">
														</a>
										...
										<c:forEach var="furniture" items="${furniture }">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												...
												<div class="single-product">
													<div class="product-img">
														<a
															href="${pageContext.request.contextPath}/detailview2?product_code=${furniture.product_code}">
															<img class="default-img"
															src="${pageContext.request.contextPath}/${furniture.thumb_img}"
															alt="#"> <img class="hover-img"
															src="${pageContext.request.contextPath}/${furniture.thumb_img}"
															alt="#">
														</a>
										...
										<c:forEach var="food" items="${food }">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												...
												<div class="single-product">
													<div class="product-img">
														<a
															href="${pageContext.request.contextPath}/detailview2?product_code=${food.product_code}">
															<img class="default-img"
															src="${pageContext.request.contextPath}/${food.thumb_img}"
															alt="#"> <img class="hover-img"
															src="${pageContext.request.contextPath}/${food.thumb_img}"
															alt="#">
														</a>
										...
										<c:forEach var="animal" items="${animal }">
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												...
												<div class="single-product">
													<div class="product-img">
														<a
															href="${pageContext.request.contextPath}/detailview2?product_code=${animal.product_code}">
															<img class="default-img"
															src="${pageContext.request.contextPath}/${animal.thumb_img}"
															alt="#"> <img class="hover-img"
															src="${pageContext.request.contextPath}/${animal.thumb_img}"
															alt="#">
														</a>
			...
			<div class="row">
				<div class="col-12">
					<div class="owl-carousel popular-slider">
						...
						<div class="single-product">
							<div class="product-img">
								<a href="${pageContext.request.contextPath}/detailview2?product_code=${recommend.product_code}"> <img class="default-img"
									src="${pageContext.request.contextPath}/${recommend.thumb_img}" alt="#"> <!-- <img class="hover-img" src="https://via.placeholder.com/550x750" alt="#">  -->
